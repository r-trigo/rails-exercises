...
=begin
r1 = Region.create(name: 'Kanto')
r2 = Region.create(name: 'Johto')
r3 = Region.create(name: 'Hoenn')
r4 = Region.create(name: 'Sinnoh')
r5 = Region.create(name: 'Unova')
r6 = Region.create(name: 'Kalos')
